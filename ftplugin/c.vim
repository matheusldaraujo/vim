...
" ---------- F-key mappings  ------------------------------------
"
"   Alt-F6   write buffer and compile
"       F6   compile and link
"  Ctrl-F6   run executable
" Shift-F6   command line arguments
"
 map  <buffer>  <silent>  <A-F6>       :call C_Compile()<CR>:call C_HlMessage()<CR>
imap  <buffer>  <silent>  <A-F6>  <C-C>:call C_Compile()<CR>:call C_HlMessage()<CR>
"
 map  <buffer>  <silent>    <F6>       :call C_Link()<CR>:call C_HlMessage()<CR>
imap  <buffer>  <silent>    <F6>  <C-C>:call C_Link()<CR>:call C_HlMessage()<CR>
"
 map  <buffer>  <silent>  <C-F6>       :call C_Run()<CR>
imap  <buffer>  <silent>  <C-F6>  <C-C>:call C_Run()<CR>
"
 map  <buffer>  <silent>  <S-F6>       :call C_Arguments()<CR>
imap  <buffer>  <silent>  <S-F6>  <C-C>:call C_Arguments()<CR>
"
